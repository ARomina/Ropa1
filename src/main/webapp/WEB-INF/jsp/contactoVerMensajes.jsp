					...
					<div class="col-sm-12">
						...
						<div class="mainmenu">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="/ropa1/contacto" class="active">CONTACTO</a></li>
    		...
    		<div class="row">  	
	    		<div class="col-sm-12">
	    			<div class="contact-form">
				    	<form:form action="" modelAttribute="mensaje" id="main-contact-form" class="contact-form row"  method="POST" name="verMensajeExito">
							<table class="table table-bordered sortable-theme-bootstrap" data-sortable>
									...
									<c:forEach items="${servicioContacto}" var="mensaje">
									<tr>
										<td>${mensaje.nombreMensaje}</td>
									  	<td>${mensaje.emailMensaje}</td>
