	...
	<header id="header">
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	...
	    	<div class="row">
	    		<div class="col-sm-12">
	    			<h2 class="title text-center col-sm-12">Mensajes</h2>
	    			<div class="contact-form">
							<form  id="main-contact-form" class="contact-form row" name="mensajes">													
								<div class="form-group col-md-12 col-sm-12">
									<a href="/ropa1/contactoVerMensajes"><input type="button" name="altaS" class="btn btn-primary pull-left col-xs-12 col-md-12 col-sm-12" value="Ver mensajes recibidos"/></a>
								</div>						
							</form>
						</div>
	    		</div>
